function addPdeConstraint(this, variable, expression, dependent, varargin)
%ADDPDECONSTRAINT Add PDE constraint to problem structure.
%
% Syntax:
...
% Copyright 2013-2014 Mikhail S. Jones
	...
	if ~this.checkVariables(expression)
	  error('coalesce:Nlp:addPdeConstraint', ...
	  	'Not all variables in constraint expression have been defined.');
	end % if
	...
	%        | 1/2  1/2
	  ...
	  % Append object array with more constraints
		this.constraint(end+1) = Constraint(defect, 0, 0, opts.description);
	end % trapezoidal
